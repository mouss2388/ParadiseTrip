...
public class EXTRA {
    ...
    public static String EXTRA_START_AIRPORT = "EXTRA_START_AIRPORT";
    public static String EXTRA_RETURN_AIRPORT = "EXTRA_RETURN_AIRPORT";
    public static String EXTRA_ALL_PASSENGERS = "EXTRA_ALL_PASSENGERS";
